...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'admin.secretarias.create',
            'admin.secretarias.store',
            'admin.secretarias.show',
            'admin.secretarias.edit',
            'admin.secretarias.update',
            'admin.secretarias.confirmDelete',
            'admin.secretarias.destroy',
