  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="row mb-3">
          <label for="password-confirm" class="col-form-label text-md-end">{{ __('Confirmación De Contraseña') }}</label>
          <div class="col-md-12">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="security_answer_1" class="form-control mt-2" placeholder="Escriba su respuesta aquí" required>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="security_answer_2" class="form-control mt-2" placeholder="Escriba su respuesta aquí" required>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-12">
            ...
            <input type="text" name="security_answer_3" class="form-control mt-2" placeholder="Escriba su respuesta aquí" required>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <a href="{{ url('login') }}" class="btn btn-secondary btn-block">Volver Al Inicio De Sesión</a>
          </div>
        </div>
      </form>
    </div>
